...
class PropertyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'main_thumbnail'          => 'required|image|mimes:jpeg,png,jpg,webp|max:4096',
            'mini_thumbnail'          => 'required|image|mimes:jpeg,png,jpg,webp|max:4096',
            'interior_images'         => 'nullable|array',
            'interior_images.*'       => 'image|mimes:jpeg,png,jpg,webp|max:4096',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'price'                   => 'required|string',
            'discount'                => 'nullable|string',
            'main_thumbnail'          => 'nullable|image|mimes:jpeg,png,jpg,webp|max:2048',
            'mini_thumbnail'          => 'nullable|image|mimes:jpeg,png,jpg,webp|max:1024',
            'interior_images'         => 'nullable|array',
